...
[Kubernetes health, readiness and liveness lab Introduction Video](youtube:z1dKR94TQOE)
...
```
  ...
  Of course the actual IP address and namespace in your environment will almost certainly be different from the example here !
